...
A complete decompilation of Retro Engine v4 and the menus from Sonic 1 and 2 (2013), ported to Nintendo Switch.
...
# FAQ
You can find the FAQ [here](https://github.com/RSDKModding/RSDKv4-Decompilation/blob/main/FAQ.md).
